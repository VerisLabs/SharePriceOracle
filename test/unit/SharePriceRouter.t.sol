...
contract SharePriceRouterTest is Test {
    ...
    function setUp() public {
        ...
        console.log("Chainlink adapter deployed at:", address(chainlinkAdapter));
        ...
        console.log("Admin has ADMIN_ROLE:", router.hasAnyRole(admin, router.ADMIN_ROLE()));
        console.log("Updater has UPDATER_ROLE:", router.hasAnyRole(updater, router.UPDATER_ROLE()));
        console.log("Endpoint has ENDPOINT_ROLE:", router.hasAnyRole(endpoint, router.ENDPOINT_ROLE()));
    }
    ...
    function testSetAssetCategory() public {
        ...
        assertEq(uint256(router.assetCategories(USDC)), uint256(SharePriceRouter.AssetCategory.STABLE), "Asset category should be set");
    }
