    ...
    function run() external {
        ...
        for (uint256 i = 0; i < targetEndpointIds.length; i++) {
            ...
            try endpoint.setPeer(targetLzId, targetPeer) {
                ...
                console.log(string.concat("Failed to set peer for ", targetChainName, ": ", reason));
            } catch {
                console.log(string.concat("Failed to set peer for ", targetChainName, " with unknown error"));
            }
        }
