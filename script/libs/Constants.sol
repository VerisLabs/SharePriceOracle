...
library Constants {
    ...
    uint32 constant ARBITRUM = 42_161;
    ...
    function getChainConfig(uint32 chainId)
        internal
        pure
        returns (uint32 lzEndpointId, address lzEndpoint, address ethUsdFeed)
    {
        if (chainId == BASE) {
            return (30_184, 0x1a44076050125825900e736c501f859c50fE728c, 0xfE1587A048b283ecEDe0AF9cbDfd6a0e531B732B);
        } else if (chainId == OPTIMISM) {
            return (30_111, 0x1a44076050125825900e736c501f859c50fE728c, 0x052f1ba9cDC9859Fd19849484b69000E54AabBA6);
        } else if (chainId == ARBITRUM) {
            return (30_110, 0x1a44076050125825900e736c501f859c50fE728c, 0xE304C2CD95eADA80C61e9782c3089fCc1576d585);
        }
