...
library ChainConfig {
    ...
    function getConfigByLzId(uint32 lzEndpointId) internal pure returns (Config memory) {
        if (lzEndpointId == 30_110) {
            return getConfig(42_161); // Arbitrum
        } else if (lzEndpointId == 30_106) {
            return getConfig(43_114); // Avalanche
        } else if (lzEndpointId == 30_184) {
            return getConfig(8453); // Base
        } else if (lzEndpointId == 30_102) {
            return getConfig(56); // BNB
        } else if (lzEndpointId == 30_101) {
            return getConfig(1); // Ethereum
        } else if (lzEndpointId == 30_112) {
            return getConfig(250); // Fantom
        } else if (lzEndpointId == 30_183) {
            return getConfig(59_144); // Linea
        } else if (lzEndpointId == 30_111) {
            return getConfig(10); // Optimism
        } else if (lzEndpointId == 30_109) {
            return getConfig(137); // Polygon
        } else if (lzEndpointId == 31_337) {
            return getConfig(31_337); // Local Anvil chain for testing
        }
        /*
